# deleting not useful functions 
# comparing verbose time and non-verbose --> gave same time
...
"""
nbr_gaussians_grad = 2 #idx // (gaussians + 1)
nbr_gaussians_rot = 3 #idx % (gaussians + 1)
